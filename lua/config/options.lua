...
vim.opt.completeopt = "menu,menuone,noselect" -- Completion options (correct for all nvim versions)
...
vim.opt.foldtext = ""                                -- Use default fold text (cleaner in nvim 0.11+)
...
vim.opt.laststatus = 3 -- Global statusline (better performance)
