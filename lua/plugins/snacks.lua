...
return {
    ...
    init = function()
        ...
        vim.api.nvim_create_autocmd("User", {
            pattern = "VeryLazy",
            callback = function()
                _G.dd = function(...) Snacks.debug.inspect(...) end -- Debug inspect.
                _G.bt = function() Snacks.debug.backtrace() end      -- Debug backtrace.
                vim.print = _G.dd                                   -- Redirect `vim.print` to `dd`.
    ...
    keys = {
        ...
        { "]]", function(count) Snacks.words.jump(count or 1) end, desc = "Next Reference", mode = { "n", "t" } },
        { "[[", function(count) Snacks.words.jump(-(count or 1)) end, desc = "Previous Reference", mode = { "n", "t" } },
    },
